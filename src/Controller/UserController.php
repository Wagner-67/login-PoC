...
final class UserController extends AbstractController
{
    ...
    public function enable2FA(
        ...
        if(!$userid->isTwoFactorEnabled()) {
            ...
            $currentCount = $twoFactor->getLoginCount() ?? 0;
            $twoFactor->setLoginCount($currentCount + 1);
        ...
        return new JsonResponse(['message'=>'2FA bereits aktiviert']);
    }
